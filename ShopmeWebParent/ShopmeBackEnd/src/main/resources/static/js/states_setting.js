...
function addState() {
	...
	$.ajax({
		...
		showToastMessage("The new states have been added");
	}).fail(function() {
		showToastMessage("ERROR: Could not connect to server or server encountered an error");
	});
}
...
function changeFormStateToNew() {
	...
	lebelStateName.text("State/Province Name:");
...
function changeFormStateToSelectedState() {
	...
	lebelStateName.text("Selected State/Province:");
...
function loadCountries4States() {
	...
	$.get(url, function(responseJSON) {
		...
		showToastMessage("All Country have been loaded");
	}).fail(function() {
		showToastMessage("ERROR: Could not connect to server or server encountered an error");
	});
}
